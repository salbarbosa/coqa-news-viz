...
1) A json file named coqa-news-preprocessed-final.json, containing information pre-processed (for part-of-speech, named entities, dependencies, coreferences, ...) with the Stanford CoreNLP system. This file may be downloaded from https://cs.mtsu.edu/~sbarbosa/qa/public/coqa-news-preprocessed-final.json  
